...
def assign_key(
    ...
    if private_key_path.exists() and public_key_path.exists():
        ...
        comments = (
            f"Key generated by {owner} for ifm OVP8xx ssh access {datetime.now()}"
        )
        ...
        if private_key_path.exists():
            ...
            if not paramiko_available:
                raise ImportError("paramiko is not available, cannot generate keys")
    ...
    current_keys_on_vpu = o3r.get(["/device/network/authorized_keys"])["device"][
        "network"
    ]["authorized_keys"]
    ...
    if public_key_signature not in current_keys_on_vpu:
        ...
        public_key_signatures = "\n".join([current_keys_on_vpu, public_key_signature])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=O3R_IP,
        help=f"IP address to be used, default: {O3R_IP}",
    )
    parser.add_argument(
        "--key_title",
        type=str,
        default="id_o3r",
        help="Title of the key, default: id_o3r",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=str(SSH_DIR),
        help="Directory to save the key, default: ~/.ssh",
    )
    parser.add_argument(
        "--log-file",
    ...
    parser.add_argument(
        ...
        type=str,
        default="oem",
        help="Specify the owner for the public key description, default: oem",
    )
